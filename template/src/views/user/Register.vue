        ...
        <div class="form-side rounded" style="width:100%;">
          ...
          >
            ...
            <b-form-group label="user-name" class="has-float-label mb-4">
              ...
              >
              <b-form-invalid-feedback v-else-if="!$v.form.username.maxLength"
                >it's too long</b-form-invalid-feedback
              >
            </b-form-group>
            ...
            <b-form-group label="password" class="has-float-label mb-4">
              ...
              <b-form-invalid-feedback
                v-else-if="
                  !$v.form.password.maxLength || !$v.form.password.maxLength
                "
                >it's too long</b-form-invalid-feedback
              >
            </b-form-group>
            <b-form-group label="repeat password" class="has-float-label mb-4">
              ...
              <b-form-invalid-feedback v-if="!$v.form.repeatPassword.sameAs"
                >it's wrong.</b-form-invalid-feedback
              >
            </b-form-group>
