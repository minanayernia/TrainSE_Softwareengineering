<template>
  <div>
    <b-row>
      <b-colxx lg="1" md="1" xl="1" sm="1"> </b-colxx>
        ...
        <b-row>
          <b-colxx v-if="currentUser != null && currentUser.role == 'A'" md="4" sm="6" lg="3" xxs="12">
            <b-card class="mb-4 text-center" v-b-modal.modalright>
              <img src="https://cdn4.iconfinder.com/data/icons/user-interface-131/32/add-512.png" alt="Card image cap"
          ...
          <b-colxx v-for="(category, index) in categoryList" :key="index" md="4" sm="6" lg="3" xxs="12">
            <b-card class="mb-4 text-center">
              <router-link :to="{
                  name: 'resource-list',
                  params: { id: category.category_id, name: category.title }
                }">
                <img src="https://ou.ac.lk/wp-content/uploads/2021/04/Software-Development.jpg" alt="Card image "
                  class="img-thumbnail list-thumbnail ] border-0 mb-4" />
              ...
              <b-row v-if="currentUser != null && currentUser.role == 'A'">
                <b-colxx lg="6">
                  <b-button variant="outline-primary" class="btn  btn-block  default text-center rounded"
                    @click="changeId(category.category_id)" v-b-modal.modall><i class="fa fa-edit fa-fw fa-lg"></i>
                  </b-button>
                </b-colxx>
                <b-colxx lg="6">
                  <b-button variant="outline-primary" class="btn  btn-block  default text-center rounded"
                    @click="deletee(category.category_id)"><i class="fa fa-trash fa-lg"></i></b-button>
                </b-colxx>
              </b-row>
            </b-card>
          </b-colxx>
